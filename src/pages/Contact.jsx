    ...
    <div className="contact-page w-full pt-32">
      ...
      <section className="px-6 md:px-margin-desktop max-w-container-max mx-auto mb-16 md:mb-section-gap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-stretch">
          {/* Contact Info Column */}
          <div className="md:col-span-5 bg-surface-container p-8 md:p-12 border border-outline-variant/30 gold-glow flex flex-col justify-between">
            <div>
          ...
          {/* Map Column */}
          <div className="md:col-span-7 relative h-[400px] md:h-auto overflow-hidden border border-outline-variant/30">
      ...
      <section className="bg-surface-container-low py-16 md:py-section-gap overflow-hidden">
        <div className="px-6 md:px-margin-desktop max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {/* Main Hall */}
            <div className="group relative overflow-hidden h-[300px] md:h-[500px]">
            ...
            {/* Lounge Area */}
            <div className="group relative overflow-hidden h-[300px] md:h-[500px] md:mt-12">
            ...
            {/* Artisanal Bar */}
            <div className="group relative overflow-hidden h-[300px] md:h-[500px] sm:col-span-2 md:col-span-1">
      ...
      <section className="py-16 md:py-section-gap px-6 md:px-margin-desktop max-w-container-max mx-auto">
        <div className="border border-outline-variant/30 p-10 md:p-24 relative overflow-hidden text-center gold-glow">
